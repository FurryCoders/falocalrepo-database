...
class SubmissionsColumns(Columns):
    ...
    FILEURLS: Column = Column("FILEURLS", list[str], from_entry=parse_list)
    FILES: Column = Column("FILES", list[str], from_entry=parse_list)
    THUMBNAIL: Column = Column("THUMBNAIL", str)
